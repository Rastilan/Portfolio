  ...
  return (
    <section ref={sectionRef} className="py-12 px-4 max-w-6xl mx-auto">
      <h2 className="text-3xl font-bold text-center mb-8 text-white">Contact Me</h2>
        <div ref={contactInfoRef} className="bg-black p-6 rounded-lg shadow-md border-2">
          ...
          <p className="text-white mb-4 text-left">
            Im always looking for new ways to grow and be involved in more things. Feel free to reach out to me and lets get coding!
          </p>
          <ul className="space-y-2 flex flex-col">
            ...
            <li className="flex items-center text-white text-sm md:text-base">
              ...
              <a href="https://www.linkedin.com/in/christopher-b-hall">
